...
import (
	...
	"github.com/safecorners2015/go-in-action/chapter7/patterns/runner"
)

// timeout is the number of second the program has to finished.
...
// createTask returns an example task taht sleeps for the specified
