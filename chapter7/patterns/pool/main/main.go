// this example program demonstrates how to use the pool package
...
import (
	...
	"github.com/safecorners2015/go-in-action/chapter7/patterns/pool"
)
...
func createConnection() (id.Closer, error) {
